...
public class CRUDFiguraGeometrica implements ICRUDFiguraGeometrica {
	...
	public boolean carica() {
		...
		try(BufferedReader bufferedReader = new BufferedReader(new FileReader("C:\\Users\\User\\Documents\\Esercizio Testing Forme_Geometriche.zip_expanded\\Esercizio_Testing_Forme_Geometriche\\dati\\figuregeometriche.dat"))) {
	...
	public boolean salva() {
		// Creare la cartella c:\dati
		try(FileWriter fileWriter = new FileWriter("C:\\Users\\User\\Documents\\Esercizio Testing Forme_Geometriche.zip_expanded\\Esercizio_Testing_Forme_Geometriche\\dati\\figuregeometriche.dat")) {
